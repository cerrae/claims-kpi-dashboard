...
function renderKPIs(data) {
  ...
  document.getElementById('kpi-total-ar').textContent = money(0);
  document.getElementById('kpi-rejection-rate').textContent = '0%';
  document.getElementById('kpi-avg-days').textContent = '0';
  document.getElementById('kpi-open-cases').textContent = '0';

  animateValue(document.getElementById('kpi-total-ar'), totalAR, (v) => money(v));
  animateValue(document.getElementById('kpi-rejection-rate'), rejectionRate, (v) => `${v.toFixed(1)}%`);
  animateValue(document.getElementById('kpi-avg-days'), avgDays, (v) => Math.round(v));
  animateValue(document.getElementById('kpi-open-cases'), open.length, (v) => Math.round(v));
}
